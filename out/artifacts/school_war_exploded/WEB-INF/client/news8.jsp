...
<div class="container">
    ...
    <div style="margin-top: 80px;" class="border border-1 shadow-lg">
        <h5 class="text-center mt-4">春日，将艺术吃进肚子</h5>
        <div class="small text-center">2023-04-2 </div>
        <div class="mx-5" style="text-indent: 2rem;">
            <br>
            <br>
            <div class="text-center my-4"><img src="<%=path%>/static/img/news07.jpg" alt="" style="width: 80%;
    height: 450px;"></div>

            <p>  --“为什么学校的天空总是那么好看？”</p>

            <p>    --“因为最张扬的青春配得上最好的朝阳和晚霞。”</p>
