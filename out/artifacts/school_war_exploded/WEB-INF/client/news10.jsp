...
<div class="container">
    ...
    <div style="margin-top: 80px;" class="border border-1 shadow-lg">
        <h5 class="text-center mt-4">湖北·武汉</h5>
        <div class="small text-center">2023-03-29 </div>
        ...
        <div class="mx-5" style="text-indent: 2rem;">
            ...
            <div class="text-center my-4"><img src="<%=path%>/static/img/news11%20(1).jpg" alt="" style="width: 25%;
    height: 450px;"></div>

            <p> 总要去趟武汉吧</p>

            <div class="text-center my-4"><img src="<%=path%>/static/img/news11%20(2).jpg" alt="" style="width: 80%;
    height: 450px;"></div>

            <p>惹得诗人说到今</p>

            <div class="text-center my-4"><img src="<%=path%>/static/img/news11%20(3).jpg" alt="" style="width: 80%;
    height: 450px;"></div>
            <br/>
